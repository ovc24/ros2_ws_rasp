...
def process_ros2_controllers_config(context):
    ...
    #     home,
    #     'ros2_ws_rasp/src/ovcrobot_moveit_config/config',
    #     robot_name
    # )
    # install_config_path = os.path.join(
    #     home,
    #     'ros2_ws_rasp/install/ovcrobot_moveit_config/share/ovcrobot_moveit_config/config',
    #     robot_name
    # )
...
ARGUMENTS = [
    # DeclareLaunchArgument('robot_name', default_value='ovcrobot',
...
def generate_launch_description():
    ...
    """
    # Define filenames
    urdf_package = 'ovcrobot_description'
    urdf_filename = 'ovcrobotv3_copp.urdf'
    # rviz_config_filename = 'ovcrobot_description.rviz'
